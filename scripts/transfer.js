...
async function main() {
  ...
  const replace_contractAddress = "0x358917BbD9DFADBAB4179a8E8610EA20959D9F16";

  // Get the signer (your account)
  const [signer] = await hre.ethers.getSigners();

  // Create a contract instance
  const replace_contractFactory = await hre.ethers.getContractFactory("SwisstronikERC20");
